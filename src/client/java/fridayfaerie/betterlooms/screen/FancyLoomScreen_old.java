...
public class FancyLoomScreen_old extends HandledScreen<LoomScreenHandler> {
    ...
    public FancyLoomScreen_old(LoomScreenHandler screenHandler, PlayerInventory inventory, Text title) {
    ...
    protected void drawSlot(DrawContext context, Slot slot) {
        // hide banner, dye, pattern slots
        if (slot.id == 0 || slot.id == 1 || slot.id == 2) return;
